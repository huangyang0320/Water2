package com.wapwag.woss.modules.sys.security;
...
import com.wapwag.woss.modules.sys.entity.Menu;
...
import com.wapwag.woss.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		// 校验用户名密码
		User user = getSystemService().getUserByName(token.getUsername());
		if (user != null) {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		User user = getSystemService().getUserByName(principal.getName());
		if (user != null) {
